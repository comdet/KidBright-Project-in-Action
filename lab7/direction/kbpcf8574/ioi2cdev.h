 ...
 */
#ifndef __IOI2CDEV_H__
#define __IOI2CDEV_H__
 ...
 * @return ESP_OK on success
 */
esp_err_t i2c_dev_read(const i2c_dev_t *dev, const uint8_t *out_data,
        size_t out_size, uint8_t *in_data, size_t in_size);
 ...
 * @return ESP_OK on success
 */
esp_err_t i2c_dev_write(const i2c_dev_t *dev, const uint8_t *out_reg,
